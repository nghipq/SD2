...
vectors_file = [("training_set_dom_den.csv", 2), ("training_set_dom_trang.csv", 2), ("training_set_den_mang.csv", 2), 
("training_set_hoai_tu_co.csv", 2), ("training_set_hoai_tu_gan.csv", 2), ("training_set_tom_bt.csv", 2)]
kmeans = []
